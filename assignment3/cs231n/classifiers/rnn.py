...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        vocab_scores, cache['temporal_affine'] = temporal_affine_forward(h, W_vocab, b_vocab)
        loss, dvocab_scores = temporal_softmax_loss(vocab_scores, captions_out, mask)

        dh, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dvocab_scores, cache['temporal_affine'])
